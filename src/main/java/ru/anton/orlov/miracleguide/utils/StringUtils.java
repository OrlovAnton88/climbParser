...
/**
 * Created by antonorlov on 28/10/15.
 */
...
//        en = "eh|ju|ja|shh|ch|sh|kh|jo|zh|a|b|v|g|d|e|z|i|j|k|l|m||n|o|p|r|s|t|u|f|c||y|".split("|");
//
//        ru = "э|ю|я|щ|ч|ш|х|е||ж|а|б|в|г|д|е|з|и|й|к|л|м||н|о|п|р|с|т|у|ф|ц|ъ|ы|ь".split("|");
//
//    }
//
...
//    public String rusToTranslit(final String str) {
//        String result;
//
//
//
//        for (int i = 0; i < en.length; ++i)
//            while (ru.indexOf(ru[i]) >= 0)
